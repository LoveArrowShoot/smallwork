...
bool GameApp::InitResource()
{
	...
	/*
		VertexPosColor vertices[] =
		{
			//方法二:采用等六边形的六个顶点组成连续的三角形
			{ XMFLOAT3(-0.5f, 0.99f, 0.5f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f) },	
			{ XMFLOAT3(0.5f, 0.99f, 0.5f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
			{ XMFLOAT3(1.0f, 0.0f, 0.5f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f) },		
			{ XMFLOAT3(0.5f, -1.0f, 0.5f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },	
			{ XMFLOAT3(-0.5f, -1.0f, 0.5f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },	
			{ XMFLOAT3(-1.0f, 0.0f, 0.5f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f) },
	...
	// 设置图元类型，设定输入布局			//方法二:D3D11_PRIMITIVE_TOPOLOGY_TRIANGLESTRIP
